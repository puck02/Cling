...
Write-Host ""
Write-Host "irm https://raw.githubusercontent.com/puck02/Cubytes/main/scripts/install-portable.ps1 | iex" -ForegroundColor Cyan
Write-Host ""
...
# 克隆仓库
Write-Host "[3/5] 下载 Cubytes..." -ForegroundColor Yellow
...
Write-Host "  1. cd Cubytes" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "提示: 便携版 GCC 在 Cubytes\mingw64 目录" -ForegroundColor Yellow
Write-Host ""
